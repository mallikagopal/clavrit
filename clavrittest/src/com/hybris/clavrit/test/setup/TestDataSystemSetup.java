 ...
 */
package com.hybris.clavrit.test.setup;
...
import com.hybris.clavrit.test.constants.ClavritTestConstants;
import com.hybris.clavrit.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = ClavritTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/clavrittest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/clavrittest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/clavrittest/import/cstickets.impex");
			...
			importImpexFile(context, "/clavrittest/import/csquotes.impex");
		}
	}
}
