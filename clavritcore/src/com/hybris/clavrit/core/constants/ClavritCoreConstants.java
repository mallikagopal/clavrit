 ...
 */
package com.hybris.clavrit.core.constants;

/**
 * Global class for all ClavritCore constants. You can add global constants for your extension into this class.
 */
public final class ClavritCoreConstants extends GeneratedClavritCoreConstants
{
	public static final String EXTENSIONNAME = "clavritcore";


	private ClavritCoreConstants()
	{
		//empty
	}
