...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/clavritstorefront/electronics/en",
						"https://electronics.local:9002/clavritstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/clavritstorefront/electronics/en",
						"https://electronics.local:9002/clavritstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/clavritstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/clavritstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/clavritstorefront/electronics/en",
						"https://electronics.local:9002/clavritstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/clavritstorefront",
						"https://electronics.local:9002/clavritstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/clavritstorefront",
						"https://electronics.local:9002/clavritstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/clavritstorefront/electronics/en",
						"https://electronics.local:9002/clavritstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
