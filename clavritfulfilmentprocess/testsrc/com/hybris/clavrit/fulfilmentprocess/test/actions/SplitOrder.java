 ...
 */
package com.hybris.clavrit.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(ClavritFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(ClavritFulfilmentProcessConstants.PARENT_PROCESS);
